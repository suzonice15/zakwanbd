            ...
            <form action="{{ url('admin/slider/update') }}/{{ $slider->homeslider_id }}" class="form-horizontal" method="post"
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-12" style="margin-left: 25px">
                        ...
                        <div class="form-group ">
                            <label for="category_name">Slider Color<span class="required">*</span></label>
                            <input required type="color" class="form-control" id="slider_color"
                                   name="slider_color"
                                   value="{{$slider->slider_color}}">
