...
<div class="row" style="cursor: pointer;">
    ...
    <div class="col-12 col-lg-12 col-xl-12">
        ...
        {{--<button onclick="orderStatus('phone_pending')" type="button" class="btn btn-primary order_status "> Phone Pending <span class="badge badge-light"> {{getOrderCount('phone_pending')}}</span>--}}
        {{--</button>--}}

        <button onclick="orderStatus('pending_payment')" type="button" class="btn btn-primary order_status ">  Pending Payment <span class="badge badge-light"> {{getOrderCount('phone_pending')}}</span>
        </button>
        <button onclick="orderStatus('processing')" type="button" class="btn btn-primary order_status " style="background: #f9be0c;color:black">  Processing  <span class="badge badge-light" style="color:black">     {{getOrderCount('phone_pending')}}</span>
        </button>
        ...
        <button onclick="orderStatus('delivered')" type="button" class="btn btn-primary order_status " style="background: green;">  Delivered  <span class="badge badge-light">     {{getOrderCount('delivered')}}</span>
        </button>
        ...
        <button onclick="orderStatus('failed')" type="button" class="btn btn-primary order_status " style="background: red;">  Failed  <span class="badge badge-light">     {{getOrderCount('failed')}}</span>
        </button>
