...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="container">
        <div class="row" style="margin-bottom: 50px;margin-top: 10px">
            <div class="col-md-11 col-sm-12" id="messages">
                <span class="messagebox">
                      <?php echo $__env->make('admin.affilate.affilite_chat_message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </span>
            </div>
        ...
        <script>
            var user_id = "<?php echo e(Session::get('id')); ?>";
            $(document).ready(function () {
                ...
                $(document).on('click', '#submit_chat', function (e) {
                    ...
                    if ( message != '' ) {
                        ...
                        $.ajax({
                            type: "post",
                            url: "<?php echo e(url('/')); ?>/chatStoreFromAffiliate", // need to create this post
                            data: {
                                message:message,
            ...
            function getChat() {
                $.ajax({
                    type:"GET",
                    url:"<?php echo e(url('getchat/fromAffilite')); ?>",
                    success:function(data)
                    {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/admin/affilate/affilite_chat.blade.php ENDPATH**/ ?>