                ...
                <?php if($status=='super-admin' || session::get('email')=='suzonice15@gmail.com' || session::get('email')=='admin@zakwanbd.com'): ?>
                    ...
                    <li class="dropdown messages-menu">
                        <a  class="padding_class_a" href="<?php echo e(url('/cart')); ?>" >
                            ...
                            <span class="label label-danger"><?php echo e($quantity); ?></span>
                        </a>

                    </li>

                    <li class="dropdown messages-menu">
                        <a class="padding_class_a"  href="<?php echo e(url('/')); ?>/wishlist" >
                            <i class="fa fa-heart-o"  ></i>
                            <?php if(Session::get('total_wishlist_count')>0): ?>
                                <span  class="label label-danger" id="wishlist_count"><?php echo e(Session::get('total_wishlist_count')); ?></span>
                            <?php endif; ?>
                    ...
                    <li class="dropdown messages-menu">
                        <a  class="padding_class_a" href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="label label-success"><?php echo e($total_messages); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="header">You have <?php echo e($total_messages); ?> messages</li>
                            <li>
                                <ul class="menu">
                                   <?php if($messages): ?>
                                       <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(url('/')); ?>/user/message">
                            ...
                            <li class="footer"><a href="<?php echo e(url('/')); ?>/user/message">See All Messages</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown messages-menu">
                        <a  class="padding_class_a" href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span style=" font-size: 15px;" class="label label-danger"><?php echo e($total_unsen_notification); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="header">You have <?php echo e($total_unsen_notification); ?> notifications</li>
                            <li>
                                 <ul class="menu">
                                   <?php if($notifications): ?>
                                    ...
                                    <li>
                                        <div class="pull-left">
                                            <img   src="https://www.zakwanbd.com/public/uploads/<?php echo e($notification->folder); ?>/small/<?php echo e($notification->feasured_image); ?>" class="img-circle" alt="User Image">
                                        </div>
                                        <a href="#" >
                                            <p class="<?php echo e($notification->status==0 ? 'notification_active_class':'notification_inactive_class'); ?>" ><?php echo e($notification->product_title); ?></p>
                                            <p class="<?php echo e($notification->status==0 ? 'notification_active_class':'notification_inactive_class'); ?>" >Old Price :<?php echo e($notification->previous_price); ?> Taka       New Price: <?php echo e($notification->present_price); ?> Taka</p>
                                        </a>
                                    </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       <?php endif; ?>
                            ...
                            <li class="footer"><a href="<?php echo e(url('/')); ?>/user/product/notification">See All notifications</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown user user-menu">
                        <a  class="padding_class_a"  href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            if($image){
                            ?>
                            <img style="height: 20px; width: 25px;" src="<?php echo e(url('public/uploads/')); ?>/<?php echo e(Session::get('picture')); ?>" class="img-circle"
                                 alt="User Image">

                            <?php } else { ?>

                            <img style="height: 20px; width: 25px;" src="<?php echo e(url('/')); ?>/public/uploads/user.png" class="img-circle"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <img src="<?php echo e(url('/')); ?>/public/uploads/user.png" class="img-circle"
                                     alt="User Image">
                                ...
                                <p>
                                    ...
                                    <small><?php echo e(Session::get('created')); ?></small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
...
<?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/layouts/includes/header.blade.php ENDPATH**/ ?>