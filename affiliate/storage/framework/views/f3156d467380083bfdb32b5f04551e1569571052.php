...
<body>
  ...
  <div class="login-container">
    ...
    <form action="<?php echo e(url('/')); ?>/forgotPassword" method="post" onsubmit="return validateForm()">
      <?php echo csrf_field(); ?>
      ...
      <div class="input-container">
        ...
        <input type="email" name="email" placeholder="" class="input-field">
      </div>
      ...
      <!-- <div class="forgot-password">
        <span><a href="<?php echo e(URL::to('/forgot-password')); ?>">Login here...</a></span>
      </div> -->
    </form>
  </div>
...
<?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/website/forgate_password.blade.php ENDPATH**/ ?>