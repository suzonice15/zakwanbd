...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="box-body" style="background: #f2f2f2;">
        ...
        <div class="row" id="link_products">
            ...
            <?php echo $__env->make('admin.affilate.tendingProductPagination', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            function fetch_data(page, query)
            {
                $.ajax({
                    type:"GET",
                    url:"<?php echo e(url('user/tending/productPagination')); ?>?page="+page+"&query="+query,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\Jacwan\affiliate\resources\views/admin/affilate/tendingProducts.blade.php ENDPATH**/ ?>