...
<?php if(isset($products)): ?>
    ...
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-2 col-xs-6" style="padding: 5px;">
            ...
            <p class="code" style="text-align:center" >Code :<?php echo e($product->sku); ?></p>
                ...
                <div class="text-center price "  style="display: flex;flex-direction: row;justify-content: space-between;">
                    ...
                    if($product->discount_price){
                    ?>
                    <p   style="font-weight: bold;color: red;font-size: 13.3px;"> <?php echo '৳ ' . number_format($product->product_price, 2); ?></p>
                    <?php
                    }
                    ?>
                    <p  style="font-weight: bold;color: black;font-size: 13.3px;"> <?php echo '৳ ' . number_format($sell_price, 2); ?></p>
                </div>
...
">
                    ...
                    <?php else: ?>
                    <?php if($product->product_promotion_active==0): ?>
                   ...
                   <?php else: ?>
                      ...
                      <a type="button"  target="_blank"   href="https://www.sohojbuy.com/<?php echo e($product->product_name); ?>"
...
<?php endif; ?><?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/admin/affilate/product_pagination.blade.php ENDPATH**/ ?>