    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h2 style="color:green;text-align: center"><?php echo e(session::get('success')); ?></h2>
                <!-- Custom Tabs -->
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <form method="post" action="<?php echo e(url('/')); ?>/admin/default/setting">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <form method="post" action="<?php echo e(url('/')); ?>/contest-commision">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped   ">
                                    ...
                                    <?php echo $__env->make('admin.affilate.contestHistoryPagination', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </tbody>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(page, query) {
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('admin/contest/history/pagination')); ?>?page=" + page + "&query=" + query,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/admin/affilate/contestHistory.blade.php ENDPATH**/ ?>