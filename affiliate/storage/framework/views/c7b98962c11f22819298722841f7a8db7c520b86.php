  ...
  <!-- /.content-wrapper -->
    <footer class="main-footer  " >
        ...
        <strong id="footer-copy-desktop">&copy; 2015-<?=date('Y')?> Developed by Jibonpata IT Limited.
        All rights reserved by Jibonpata IT Limited.</strong>
        <strong id="footer-copy-mobile">&copy; 2015-<?=date('Y')?> Developed by Jibonpata IT Limited.
           <br> All rights reserved by Jibonpata IT Limited.</strong>
...
<?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/layouts/master.blade.php ENDPATH**/ ?>