...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href=" <?php echo e(url('admin/labelHistory')); ?>">
...
<li>
    <a href=" <?php echo e(url('admin/commisionSetting')); ?>"><i class="fa fa-arrow-right" style="font-size: 20px"></i> Commision Setting</a>
</li>
...
<li><a href=" <?php echo e(url('admin/affiliate/complain')); ?>">
        ...
        Affiliate Complain</a><?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/layouts/includes/admin_sidebar.blade.php ENDPATH**/ ?>