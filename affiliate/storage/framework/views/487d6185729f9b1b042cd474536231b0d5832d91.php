                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-12 col-xs-12">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><?php echo e($fund->amount); ?> Taka</span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                    <!-- /.info-box -->
                                ...
                                <div class="col-md-7 col-sm-12 col-xs-12">
                                    ...
                                    <form method="post" action="<?php echo e(url('/')); ?>/royalty-commision">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group">
                                            <label for="commistion_lavel_1">Position 1</label>
                                            <input type="number" class="form-control" name="commistion_lavel_1"
                                                   id="commistion_lavel_1" value="<?php echo e($commision->commistion_lavel_1); ?>" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_2"
                                                   id="commistion_lavel_2" value="<?php echo e($commision->commistion_lavel_2); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_3"
                                                   id="commistion_lavel_3" value="<?php echo e($commision->commistion_lavel_3); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 4</label>
                                            <input type="number" class="form-control" name="commistion_lavel_4"
                                                   id="commistion_lavel_4" value="<?php echo e($commision->commistion_lavel_4); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 5</label>
                                            <input type="number" class="form-control" name="commistion_lavel_5"
                                                   id="commistion_lavel_5" value="<?php echo e($commision->commistion_lavel_5); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 6</label>
                                            <input type="number" class="form-control" name="commistion_lavel_6"
                                                   id="commistion_lavel_6" value="<?php echo e($commision->commistion_lavel_6); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 7</label>
                                            <input type="number" class="form-control" name="commistion_lavel_7"
                                                   id="commistion_lavel_7" value="<?php echo e($commision->commistion_lavel_7); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 8</label>
                                            <input type="number" class="form-control" name="commistion_lavel_8"
                                                   id="commistion_lavel_8" value="<?php echo e($commision->commistion_lavel_8); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 9</label>
                                            <input type="number" class="form-control" name="commistion_lavel_9"
                                                   id="commistion_lavel_9" value="<?php echo e($commision->commistion_lavel_9); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        <div class="form-group">
                                            <label for="commistion_lavel_2">Position 10</label>
                                            <input type="number" class="form-control" name="commistion_lavel_10"
                                                   id="commistion_lavel_10"  value="<?php echo e($commision->commistion_lavel_10); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_11"
                                                   id="commistion_lavel_11"  value="<?php echo e($commision->commistion_lavel_11); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_12"
                                                   id="commistion_lavel_12"  value="<?php echo e($commision->commistion_lavel_12); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_13"
                                                   id="commistion_lavel_13"  value="<?php echo e($commision->commistion_lavel_13); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_14"
                                                   id="commistion_lavel_14"  value="<?php echo e($commision->commistion_lavel_14); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_15"
                                                   id="commistion_lavel_15"  value="<?php echo e($commision->commistion_lavel_15); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_16"
                                                   id="commistion_lavel_16"  value="<?php echo e($commision->commistion_lavel_16); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_17"
                                                   id="commistion_lavel_17"  value="<?php echo e($commision->commistion_lavel_17); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_18"
                                                   id="commistion_lavel_18"  value="<?php echo e($commision->commistion_lavel_18); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_19"
                                                   id="commistion_lavel_19"  value="<?php echo e($commision->commistion_lavel_19); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="commistion_lavel_20"
                                                   id="commistion_lavel_20"  value="<?php echo e($commision->commistion_lavel_20); ?>" aria-describedby="emailHelp"
                                                   placeholder="Enter Commision in desimal formate">
                                        </div>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped   ">
                                    ...
                                    <?php echo $__env->make('admin.affilate.royaltyHistoryPagination', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </tbody>
                        ...
                        <div class="tab-pane" id="tab_3">
                            <form action="<?php echo e(url('/')); ?>/royalty-found-distribution" method="post">
                                <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(page, query) {
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('admin/royalty/history/pagination')); ?>?page=" + page + "&query=" + query,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\Jacwan\affiliate\resources\views/admin/affilate/royaltyHistory.blade.php ENDPATH**/ ?>