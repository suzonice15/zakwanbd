        ...
        <div class="col-md-2 col-xs-6" style="padding: 5px;">
            ...
            <div class="single-product" style="background-color: white;padding: 9px 14px;">
                ...
                <div class="text-center price "  style="display: flex;flex-direction: row;justify-content: space-between;">
                    ...
                    if($product->discount_price){
                    ?>
                    <p   style="font-weight: bold;color: red;font-size: 11.3px;"> <?php echo '৳ ' . number_format($product->product_price, 2); ?></p>
                    <?php
                    }
                    ?>
                    <p  style="font-weight: bold;color: black;font-size: 11.3px;"> <?php echo '৳ ' . number_format($sell_price, 2); ?></p>
                </div>
...
<?php echo $products->links(); ?>
    ...
    </div><?php /**PATH C:\SXampp\htdocs\Jacwan\affiliate\resources\views/admin/affilate/hot_product_pagination.blade.php ENDPATH**/ ?>