<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form method="POST" name="supend" action="<?php echo e(url('/affiliate/supend/save')); ?>">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH D:\xampp7\htdocs\zakwanbd\affiliate\resources\views/admin/affilate/single_suspend_view.blade.php ENDPATH**/ ?>