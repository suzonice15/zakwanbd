...
font-size: 23px;">
    ...
    <div class="container_login">
        ...
        <div class="input-container fieldHiden">
            <i class="fa fa-user icon"></i>
            <input class="input-field" type="text" placeholder="Referral ID" name="parent_id" value="<?php echo  Cookie::get('referrer_user')?>" autocomplete="off">
        </div>
        ...
        <div class="input-container varificationClassSectionHide">
            ...
            <input style="width: 80%" type="hidden" id="varification_code_check"  name="varification_code_check" value="{{Session::get('code')}}">
        ...
        <div style="margin-top: 5px; font-size: 15px; font-weight: 600; display: inline-flex;">
            <span class="fieldHiden" style="color: black"> Already have an account ? <a style="color: green" class="fieldHiden" href="{{URL::to('login')}}">Sign in</a></span>
        </div>
    </div>
