...
<style>
    ...
    .desktop_image {
        background-image: url(https://www.sohojbuy.com/storage/sohojaffiliates.jpg) !important;
    ...
    <div class="container remove_class desktop_image">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5">
                ...
                <br />
                <a href="{{url('/')}}/registration" class="start_now"> এখনি শুরু করুন </a>
    ...
    <div class="container why_you_work_inaffilite">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <center><img src="https://www.sohojbuy.com/public/uploads/invite.png" style="width:80px;height:60px;">
                    <h4>ইনভাইট এন্ড প্রমোট</h4>
                </center>
            ...
            <div class="col-md-3">
                ...
                <center><img src="https://www.sohojbuy.com/public/uploads/states.png" style="width:70px;height:60px;">
                    <h4>ট্র্যাক এন্ড এনালাইজ</h4>
                </center>
