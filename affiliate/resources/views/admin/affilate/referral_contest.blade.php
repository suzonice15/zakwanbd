...
<div class="contest result" style="padding: 5px;">
    <a href="{{url('/')}}/user/contest/one" class="btn btn-info ">Contest one result</a>
    <a href="{{url('/')}}/user/contest/two" class="btn btn-info ">Contest two result</a>
...
">
 <div class="col-md-6">
            ...
            <h4  >Total Contest Prize Fund  ={{$contest_fund}}
                Taka </h4>
        ...
        <div class="col-md-6" style="background-color: #13660c;border:1px solid #13660c ">
            ...
            <h4 style=""> Contest ending in   <span class='countdown' value='<?php echo date('Y-m-d',strtotime(get_option('contest_last_date'))) ?>'></span></h4>
