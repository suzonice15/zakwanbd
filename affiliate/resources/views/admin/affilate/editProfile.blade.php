...
@section('mainContent')
    ...
    <div class="box-body">
        ...
        <div class="col-sm-offset-0 col-md-12">
            <form action="{{ url('admin/affilite/updateProfile') }}/{{ $user->admin_id }}" class="form-horizontal" method="post"
                ...
                <?php } ?>
					...
					@if($user->picture)
					  <div class="form-group featured-image">
						...
						<img src="{{ env('APP_ECOMMERCE') }}public/uploads/users/{{ $user->picture }}">
