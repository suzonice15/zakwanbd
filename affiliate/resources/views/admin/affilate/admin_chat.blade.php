    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="user-wrapper">
                    @include('.admin.affilate.getChatUser')
                </div>
            </div>
        ...
        <script>
            ...
            function messageConvert(status) {
             let affilite_id= $("#affilite_id").val();
                if(affilite_id >0) {
                    $.ajax({
                        type: "get",
                        url: "{{url('/')}}/admin/message/messageConvert/" + affilite_id + "/" + status,
            ...
            function affiliate_by_message_status(status){
                    $.ajax({
                    type: "get",
                    url: "{{url('/')}}/admin/message/message_status/" + status, // need to create this route
                    success: function (data) {
            ...
            $(document).ready(function () {
                ...
                $(document).on('click','.user',function () {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{url('/')}}/admin/chat/" + receiver_id, // need to create this route
                        success: function (data) {
                            $('#messages').html(data);
                            scrollToBottomFunc();
                        }
                ...
                $(document).on('keyup', '.input-text input', function (e) {
                    ...
                    if (e.keyCode == 13 && message != '' && receiver_id != '') {
                        ...
                        $.ajax({
                            type: "post",
                            url: "{{url('/')}}/chatStoreFromAdmin", // need to create this post
                            data: {
            ...
            function getChatUser() {
                $.ajax({
                    type: "get",
                    url: "{{url('/')}}/getChatUser", // need to create this post
