...
@section('mainContent')
    ...
    <div class="box-body">
        ...
        <div class="col-sm-offset-0 col-md-12">
            ...
            <form  name="product" action="{{ url('admin/updateProduct') }}/{{ $product->product_id }}" class="form-horizontal"
                   method="post"
                                ...
                                <div class="box-body" style="padding: 22px;">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select name="hot_product"     class="form-control">
                                            <option value="0" <?php if($product->hot_product=='0'){echo "selected";} ?> >No</option>
                                            <option value="1" <?php if($product->hot_product=='1'){echo "selected";} ?>>Yes</option>
                                        </select>
                                    </div>
                                    <div class="form-group ">
                                        <label for="stock_qty">Cash Back</label>
                                        <input type="text" class="form-control" name="cash_back" id="product_stock"
                                               value="{{ $product->cash_back }}" autocomplete="off">
                                    </div>

                                    <div class="form-group">
                                        <label for="stock_qty">Top Deals</label>
                                        <input type="text" class="form-control" name="hot_deal" id="top_deal"
