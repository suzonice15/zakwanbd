    ...
    @foreach ($products as $product)
        ...
        <div class="col-md-2 col-xs-6" style="padding: 5px;">
            ...
            <div class="single-product" style="background-color: white;padding: 9px 14px;">
                ...
                <p class="code" style="text-align:center" >Code :{{$product->sku}} <span style="color:green">Sold:{{$product->product_order_count}}</span></p>
                ...
                <div class="text-center price "  style="display: flex;flex-direction: row;justify-content: space-between;">
                    ...
                    if($product->discount_price){
                    ?>
                    <p   style="font-weight: bold;color: red;font-size: 12.3px;"> @money($product->product_price)</p>
                    <?php
                    }
                    ?>
                    <p  style="font-weight: bold;color: black;font-size: 12.3px;"> @money($sell_price)</p>
                </div>
