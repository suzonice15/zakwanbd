                ...
                <div id="owl-single-productg">
                    <div class="single-product-gallery-item ">
                        <img class="xzoom img-responsive" alt=""
                             src="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->feasured_image }}"
                             xoriginal="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->feasured_image }}"/>
...
" >
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover" src="{{ env('APP_ECOMMERCE') }}public/uploads/{{ $product->folder }}/{{ $product->feasured_image }}" width="85" alt=""
                                  />
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover"  src="{{ env('APP_ECOMMERCE') }}public/uploads/{{ $product->folder }}/{{ $product->galary_image_1 }}" width="85" alt=""
                                />
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover " width="85" alt=""
                                src="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->galary_image_2 }}"/>
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover " width="85" alt=""
                                 src="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->galary_image_3 }}"/>
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover " width="85" alt=""
                                 src="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->galary_image_4 }}"/>
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover " width="85" alt=""
                                 src="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->galary_image_5 }}"/>
                        ...
                        <li>
                            <img class="img-responsive thum_image_hover " width="85" alt=""
                                src="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/{{ $product->galary_image_6 }}"/>
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <a data-picture="{{ env('APP_ECOMMERCE') }}public/uploads//{{ $product->folder }}/small/{{ $product->feasured_image}}"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <a class="btn btn-primary add_to_cart"
                                                   href="https://www.sohojbuy.com/{{$product->product_name}}"> ADD TO CART</a>
                                                <a href="https://www.sohojbuy.com/{{$product->product_name}}"
                    ...
                    <div id="review" class="tab-pane">
                        <div class="product-tab">
                            <div class="col-sm-12 text-left" style="padding:0 20px">
                                    ...
                                    <form class="form-vertical reviewform">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="name" id="name"
                                                   ...
                                                   value="{{Session::get('name')}}" placeholder="Name"
                                ...
                                <?php } else {  ?>
                                <a href="{{URL::to('customer/login')}}" target="_blank"
